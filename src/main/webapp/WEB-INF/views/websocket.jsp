...
<body>
	...
	<script type="text/javascript">
		...
		/* if ('WebSocket' in window) {
			...
			websocket = new WebSocket(
					"ws://localhost:8080/schoolchat/ws");
			//WebSocket对应的地址      
			...
			websocket = new SockJS(
					"http://localhost:8080/schoolchat/ws/sockjs");
			//SockJS对应的地址      
		} */
	    if ('WebSocket' in window) {
			//Websocket的连接         
			websocket = new WebSocket(
					"ws://47.101.211.71:8080/schoolchat/ws");
			//WebSocket对应的地址      
		} else if ('MozWebSocket' in window) {
			//Websocket的连接          
			websocket = new MozWebSocket(
			...
			//SockJS的连接         
			websocket = new SockJS(
					"http://47.101.211.71:8080/schoolchat/ws/sockjs");
			//SockJS对应的地址      
		} 
	...
	请输入目标名称：
	<input type="text" id="targetName" /> 请输入：
